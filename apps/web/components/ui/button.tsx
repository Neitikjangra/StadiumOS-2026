  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-transparent text-text-secondary hover:bg-surface-alt hover:text-text-primary active:bg-surface-alt/80",
        secondary: "bg-surface-alt text-text-secondary hover:bg-surface-alt/80 hover:text-text-primary active:bg-surface-alt/60",
        ghost: "text-text-secondary hover:bg-surface-alt hover:text-text-primary active:bg-surface-alt/80",
        link: "text-primary underline-offset-4 hover:underline",
        success: "bg-success text-white hover:bg-success/90 active:bg-success/80 shadow-sm",
        info: "bg-info text-white hover:bg-info/90 active:bg-info/80 shadow-sm",
